import { LayoutDashboard, Building2, ImageIcon, ShieldCheck, ScrollText, Megaphone, BookOpen, ShieldPlus, Inbox, BadgeCheck, BarChart2, Zap, Settings, Activity, LucideIcon } from 'lucide-react'
