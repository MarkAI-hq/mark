    ...
    <div className="rounded-lg border border-slate-200 bg-slate-50 overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-slate-600">Prediction calibration</span>
          <span className="text-[10px] text-slate-400 bg-slate-200 px-1.5 rounded">Admin only</span>
        </div>
        {open
        ...
        <div className="border-t border-slate-200 px-4 py-4 space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-xs font-medium text-slate-700">Bloom&apos;s sensitivity</label>
              <span className="text-xs font-semibold text-slate-900 tabular-nums w-10 text-right">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-xs font-medium text-slate-700">Topic mastery sensitivity</label>
              <span className="text-xs font-semibold text-slate-900 tabular-nums w-10 text-right">
