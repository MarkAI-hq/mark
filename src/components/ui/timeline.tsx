...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-white dark:bg-image:url('/assets/images/dark.webp') dark:bg-neutral-950 font-sans md:px-10"
      ref={containerRef} 
    >
      ...
      <div ref={ref} className="relative max-w-6xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-11 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
